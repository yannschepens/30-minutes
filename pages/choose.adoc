...
* Perso, je peux passer 5 sessions de 30 minutes (une semaine) à trier mes flux d'info, en chercher d'autre
...
* Ne vous posez aucune limite en terme de contexte, techno, sujet
...
* Reglez les trucs chiants : le casque USB se déco tout seul, les mises à jour en attente, nettoyer les network docker, etc...

* Par exemple, régulièrement, je teste des outils de prise de note, je recherche toujours des nouveaux trucs/outils
...
* Vous direz (peut-être) : "Ce n'est pas de veille ?"
